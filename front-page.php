...
<section class="home-services">
    ...
    <div>
        ...
        <img src="<?= get_template_directory_uri();?>/img/corporate-events.webp" alt="Donovan with his partner, Chris, posing in a comedy show.">
...
<section class="home-about">
    ...
    <!-- <video src=""></video> -->
    <p>Three-time world Improv Champion and Canadian comedy award winning Donovan Workun and professional improviser of over 11 years Chris Borger form Atomic Improv, Canada’s premier improv comedy show.</p>
    ...
    <div class="socials">
        ...
        <div class="social-links">
            <a href="https://www.instagram.com/atomicimprov/" aria-label="Instagram Link"><svg viewBox="0 0 24 24" fill="none">
            ...
            <a href="https://www.facebook.com/donovan.workun" aria-label="Facebook Link"><svg viewBox="0 0 24 24" fill="none">
            ...
            <a href="" aria-label="Youtube Link"><svg viewBox="0 -3 20 20">
            ...
            <a href="" aria-label="TikTok Link"><svg fill="#000000" viewBox="0 0 32 32">

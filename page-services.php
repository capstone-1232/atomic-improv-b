...
<div>
    <section >
        ...
        <img src="<?= get_template_directory_uri()?>/img/corporate-event.png" alt="Donovan with his partner, Chris, posing while a comedy show.">
    ...
    <section >
        ...
        <div>
            <h3>What is it?</h3>
            <img src="<?= get_template_directory_uri() ?>/img/donovan-graham.png" alt="Donovan Workun (left) and Graham Neil (right) in suits posing for a picture.">
        ...
        <div>
            ...
            <img src="<?= get_template_directory_uri()?>/img/donovan-graham-2.png" alt="Donovan and Graham shaking hands.">
    ...
    <section >
        ...
        <img src="<?= get_template_directory_uri() ?>/img/santa-donovan.png" alt="Donovan Workun dressed as santa claus sitting on a chair.">
